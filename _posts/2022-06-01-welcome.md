...
Steelman Anything is the movement to try to make the strongest arguments for all sides. Its main home is at <https://steelmananything.com/> which is an organized reference and the above definition of steelmanning comes from the [introduction topic](/topics/steelmanning/#what-is-steelmanning).
